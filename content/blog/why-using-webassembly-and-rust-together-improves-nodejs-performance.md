...
[Перевод](https://developer.ibm.com/articles/why-webassembly-and-rust-together-improve-nodejs-performance/)
...
Примечание. Работа над этим инструментом все еще продолжается, и мы еще не полностью реализовали все, что является бизнес-требованиями.
