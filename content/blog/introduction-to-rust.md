...
![Владение данными в Rust](/imgs/posts/35812975_01.png)

### Движущийся

Но возникает проблема: что делать, если двум переменным назначен указатель на одни и те же данные в куче?
![двум переменным назначается указатель на одни и те же данные](/imgs/posts/35812975_02.png)
...
![два потока, работающие с одними и теми же данными](/imgs/posts/35812975_03.png)
...
![Сравнение Rust и C++](/imgs/posts/35812975_04.png)
