...
[Перевод](https://medium.com/@robertgrosse/my-experience-rewriting-enjarify-in-rust-723089b406ad)
...
Примечание. Написав это, я понял, что это можно упростить, просто взяв указатель на внешний RefCell, но в любом случае это все равно неоправданно сложно.
