...
[Перевод](https://hacks.mozilla.org/2018/03/making-webassembly-better-for-rust-for-all-languages/)
...
Изображение: логотип Rust и логотип JS с сердцем между ними
...
Изображение: конвейер от компиляции до создания привязок, упаковки и сборки.
...
1. На стороне JS закодируйте строку в числа (используя что-то вроде API TextEncoder).
    ...
    Изображение: Кольцо кодировщика, кодирующее Hello в числовой эквивалент

2. Поместите эти числа в память WebAssembly, которая по сути представляет собой массив чисел.

    Изображение: JS помещает числа в память WebAssembly
...
Изображение: JS передает строку Hello в wasm-bindgen, который выполняет всю остальную работу.
...
Изображение: несколько файлов упаковываются и публикуются в npm
...
Рисунок: граф модуля с модулями JS и WASM
...
Изображение: импорт {myFunction} из "myModule.wasm"
...
Рисунок: график модуля объединен в единый файл
