...
[Перевод](http://www.frankmcsherry.org/pagerank/distributed/performance/2015/07/08/pagerank.html)
...
Изображение: Наивная реализация распределенного PageRank без агрегирования.
...
Изображение: Реализация распределенного PageRank агрегирования на рабочем уровне.
...
Изображение: Агрегация на уровне процессов для реализации распределенного PageRank.
